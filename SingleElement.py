...
gap = 0.095
UpperCube.Translate([-2.2, 0.2, gap/2-min([z for z in UpperCube.X[:,2]]) ])
...
contact1 = Contact(slave, master, kn=1000, cubicT=None, C1Edges = False, OutPatchAllowance=1e-3, f0=0, maxGN = 0.001, mu=0.2)       # (slave, master) inputs can be surfaces as well
ctcts = [contact1]
...
## Running ##
#############
model.Solve(TimeSteps=100, recover=False, max_iter=15)
