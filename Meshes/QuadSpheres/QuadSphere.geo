...
// INPUTS
a = 0.3;			// Side inner cube
R = 1.0;			// Radius Sphere
n = 3;				// number of elements per side of cube



r = R/Sqrt(3.0);		// position diametral points
avgA = (a + Pi*R/2)/2;		// Average "quarter length"
nr = Round(n*(R-a/2/Sqrt(2))/avgA);	// number of elements per "diagonal"
...
Sphere(8) = {-0, -0, 0, R, -Pi/2, Pi/2, 2*Pi};
...
//+
Transfinite Line {13, 14, 15, 16, 20, 18, 23, 22, 21, 24, 19, 17, 4, 3, 1, 2, 6, 7, 10, 9, 11, 5, 8, 12} = n+1;
//Transfinite Line {25,26,27,28,29,30,31,32} = nr+1;
Transfinite Line {25,26,27,28,29,30,31,32} = 2;
