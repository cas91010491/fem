...
distance_layer = layers.Dense(32, activation='relu')(distance_branch)
signed_distance_output = layers.Dense(1, name='signed_distance_output')(distance_layer)

# Branch for Patch Classification
classification_branch = layers.Dense(64, activation='relu')(shared_layer)
...
projection_branch = layers.Dense(64, activation='relu')(shared_layer)
concat_for_proj_layer = layers.Concatenate()([input_layer,projection_branch,classification_branch])
projection_layer = layers.Dense(32, activation='relu')(concat_for_proj_layer)
