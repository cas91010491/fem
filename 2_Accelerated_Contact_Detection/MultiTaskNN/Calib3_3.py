...
classification_pre_output = layers.Dense(96)(classification_branch)
classification_output = layers.Activation('softmax',name='classification_output')(classification_pre_output)
...
concat_for_proj_layer2 = layers.Concatenate()([projection_layer,input_layer,classification_pre_output])
