...
projection_layer = layers.Dense(512, activation='relu')(concat_for_proj_layer)
concat_for_proj_layer2 = layers.Concatenate()([projection_layer,input_layer,classification_output])
projection_layer2 = layers.Dense(960, activation='relu')(concat_for_proj_layer2)
...
model.compile(optimizer='adam',
              loss=['mse', 'sparse_categorical_crossentropy', 'mse'],       #sparse_cat... doesnt need labels in one-hot format
