...
csv_file = "Points_on_surf.csv"  # Replace with your actual file path
data = pd.read_csv(csv_file, header=None)  # No headers in the file
data.columns = ['x', 'y', 'z', 'p_id', 'xi1', 'xi2', 'gn']  # Assign column names
