...
class FEAssembly:
    def __init__(self,X,hexahedrons , name = "unnamed", recOuters = False, outers = None):
        self.X = X
        ...
        if (recOuters and outers==None):
            outers = pickle.load(open("RecoveryOuters.dat","rb"))[name]  
